...
-   `group` je hlavní efekt skupiny. Interpretace tohoto efektu je zavádějící, protože zde panuje vysoká korelace s tempem (dle simulací cca 0,8). Kvůli značné kolinearitě s tempem navrhuji proměnou nezařadit.
